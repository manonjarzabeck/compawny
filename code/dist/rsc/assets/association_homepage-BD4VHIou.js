...
const Resources = /* @__PURE__ */ ((React, deps, RemoveDuplicateServerCss2) => {
  ...
  __vite_rsc_react__,
  __vite_rsc_assets_manifest__.serverResources["src/pages/admin/admin_crud_homepages/association_homepage.tsx"],
...
const AdminAssociationHomepage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs(jsxRuntime_reactServerExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("section", { className: styles.container, children: [
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("h2", { className: styles.title, children: "Gérer les associations" }),
      ...
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("div", { className: styles.List, children: associations?.map((item) => {
        return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: styles.Card, children: [
          ...
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("img", { src: `/img/association/${item.image}`, alt: item.name }),
...
const $$default = AdminAssociationHomepage;
const $$wrap_$$default = /* @__PURE__ */ __vite_rsc_wrap_css__($$default, "AdminAssociationHomepage");
