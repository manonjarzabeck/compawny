...
class AssoApiService {
	// préfixe de l'API
	private prefix = "/api/asso";

	// selection de tous les enregistrements
	public selectAll = async (): Promise<ApiResponse<Asso[]>> => {
	...
	public selectOne = async (id: number): Promise<ApiResponse<Asso>> => {
		const request = new Request(
