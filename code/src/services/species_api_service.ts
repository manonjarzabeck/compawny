...
class SpeciesApiService {
	// préfixe de l'API
	private prefix = "/api/species";

	// selection de tous les enregistrements
	public selectAll = async (): Promise<ApiResponse<Species[]>> => {
	...
	public selectOne = async (id: number): Promise<ApiResponse<Species>> => {
		const request = new Request(
...
export default SpeciesApiService;
