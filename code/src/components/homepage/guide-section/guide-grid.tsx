		...
		<div className={styles.guideGrid}>
			...
			*/}
			<article className={styles.guideCard}>
				...
				{/* Bouton vers la page des actions */}
			...
			{/* 
			=====================================================
			CARTE 2 : ASSOCIATIONS INTERNATIONALES
			=====================================================
			*/}
			<article className={styles.guideCard}>
				<img
				...
				{/* Bouton vers la page des associations */}
			...
			*/}
			<article className={styles.guideCard}>
				...
				{/* Bouton vers la page des adoptions */}
